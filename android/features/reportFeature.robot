...
*** Test Cases ***
TC001 - Nao deve ser possivel gerar relatorio de entradas de produtos sem preencher data
...
TC002 - Nao deve ser possivel gerar relatorio de saidas de produtos sem preencher data
    Dado que o usuario se encontra no menu
    Quando o usuario acessar a area report
...
TC006 - Deve ser possivel visualizar as saidas de produtos preenchedo o campo datas
    Dado que o usuario se encontra no menu
    Quando o usuario acessar a area report
    E acessar a area de entradas
...
TC007 - Deve ser possivel visualizar as entradas de produtos preenchedo o campo datas
    Dado que o usuario se encontra no menu
    Quando o usuario acessar a area report
    E acessar a area de saidas
    E usar a função de gerar pdf inserindo datas
